...
csv_file_path = './data/restaurant_detail_links.csv'  # 업로드한 파일 경로에 맞게 수정
...
# 처음 20개 링크를 순회하며 데이터 수집
for index, row in df_restaurants.head(20).iterrows():
...
# 수집한 데이터 저장
df.to_csv("restaurant_info_data_first_20.csv", index=False)
